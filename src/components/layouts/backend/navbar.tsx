...
export default function MainHeader() {
    return (
        <header className="w-full px-6 py-4 flex items-center justify-between bg-white dark:bg-gray-800 rounded-2xl shadow-md border-b dark:border-gray-700 transition-colors duration-300 transition-all duration-500 ease-in-out
